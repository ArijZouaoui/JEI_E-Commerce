...
const ProductCard = ({name, price, image, id, availability,description}) => {
  ...
  <Card onMouseEnter={handleHover}  className='card text-center' style={{marginTop: 10, marginBottom: 10, display:'inline-grid',cursor:'pointer' }} > 
  ...
  <Card onMouseLeave={handleHover} className='card text-center' style={{marginTop: 10, marginBottom: 10, display:'inline-grid',cursor:'pointer'}} > 
